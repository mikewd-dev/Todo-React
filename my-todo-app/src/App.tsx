      ...
      const App = () => {
        ...
        return (
          <div className="relative w-full min-h-screen text-white font-custom-font overflow-hidden">
            <div className="absolute inset-0 z-0 bg-back-light dark:bg-back-dark" />
            ...
            <div className="relative z-10 flex flex-col items-center justify-start text-[18px]">
              ...
              <div className="flex justify-between items-center w-[90vw] h-[20px]">
